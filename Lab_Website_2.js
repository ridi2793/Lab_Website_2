...
function loadStatsPage()
{
	...
	{
		var buffs_score = parseInt(table.rows[row_counter].cells[2].innerHTML);
		var opp_score = parseInt(table.rows[row_counter].cells[3].innerHTML);
...
function loadPlayersPage()
{
    ...
    for(var row_index=0; row_index<players.length; row_index++)
    {
		select += '<a class="dropdown-item" href="#" onclick="switchPlayers('+row_index+')">' +players[row_index].name+ '</a>'; 
    }
	
	document.getElementById("player_selector").innerHTML = select;
}
